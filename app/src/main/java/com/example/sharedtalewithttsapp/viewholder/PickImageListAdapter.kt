...
class PickImageListAdapter(private val clickListener: (Uri) -> Unit, private val activity : Context)
    : ListAdapter<Uri, PickImageListAdapter.CustomViewHolder>(ImageComparator) {
    companion object ImageComparator : DiffUtil.ItemCallback<Uri>() {
    ...
    inner class CustomViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        var image : ImageView = itemView.findViewById<ImageView>(R.id.recycler_view_image)
        fun bindInfo(data: Uri, position: Int) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CustomViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.image_list_recycler_view, parent, false)
        Log.d(TAG, "inflate")
